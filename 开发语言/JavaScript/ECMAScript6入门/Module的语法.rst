...
为了做到形式的对称，现在有 `提案 <https://github.com/leebyron/ecmascript-export-default-from>`_ ，提出补上这三种复合写法。
...
因此，有一个 `提案 <https://github.com/tc39/proposal-dynamic-import>`_ ，建议引入 ``import()`` 函数，完成动态加载。
